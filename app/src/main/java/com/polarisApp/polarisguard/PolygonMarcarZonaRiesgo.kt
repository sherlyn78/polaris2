...
class PolygonMarcarZonaRiesgo(
    private val mapView: MapView,
    private val mapboxMap: MapboxMap
) {

    private val SOURCE_ID = "polygon-source"
    private val LAYER_ID = "polygon-layer"
    ...
    private val prefs by lazy {
        mapView.context.getSharedPreferences("POLYGONS_DB", Context.MODE_PRIVATE)
    }
    ...
    fun initPolygon(style: Style) {
        ...
        style.addLayer(
            fillLayer(LAYER_ID, SOURCE_ID) {
                fillColor(Color.parseColor("#ff1a43"))
